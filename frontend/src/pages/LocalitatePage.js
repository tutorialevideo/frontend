...
const LocalitatePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Firme din {localitateName} - Listă companii | mFirme</title>
        <meta 
          name="description" 
          content={`Descoperă firmele din ${localitateName}. Filtrează după activitate, cifră de afaceri, profit, angajați și alte criterii.`}
        />
      </Helmet>
      ...
      <div className="bg-secondary/30 border-b border-border py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-semibold tracking-tight mb-2" data-testid="localitate-title">
            Firme din {localitateName}
          </h1>
          <p className="text-sm text-muted-foreground">
            Explorează toate companiile din {localitateName}
          </p>
        </div>
      </div>
